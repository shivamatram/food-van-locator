...
public class SettingsActivity extends AppCompatActivity {
    ...
    private TextView tvAddressesCount;
    ...
    private void updateCounts() {
        ...
        tvPaymentMethodsCount.setText(paymentCount + " payment methods saved");
    }
    ...
    private void openReviewsRatings() {
        try {
            Intent intent = new Intent(this, ReviewsRatingsMainActivity.class);
            startActivity(intent);
        } catch (Exception e) {
            Snackbar.make(findViewById(android.R.id.content), 
                "Unable to open Reviews & Ratings", Snackbar.LENGTH_SHORT).show();
        }
    }
    ...
    private void openHelpSupport() {
        showComingSoonMessage("Help & Support");
    }
    ...
    private void openPrivacyPolicy() {
        try {
            ...
            showErrorMessage("Unable to open Privacy Policy: " + e.getMessage());
        }
    }
